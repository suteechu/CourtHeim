...
const BOQ = () => {
  ...
  const [boqItems, setBoqItems] = useState([
    ...
    { id: 16, category: 'อุปกรณ์กีฬา (Sports Equipment)', item: 'โกลหนู (WINNER) เหล็กกลม 2 นิ้ว ขนาด 120x80 ซม. พร้อมตาข่าย', qty: 1, unit: 'คู่', materialPrice: 15000, laborPrice: 2000, total: 17000 },
