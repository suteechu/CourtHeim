  ...
  const courts = [
    {
      ...
      color: 'bg-green-500',
      details: {
        equipment: ['ประตูฟุตซอลเหล็กมาตรฐานพร้อมตาข่าย', 'โครงข่ายตาข่ายกันบอลรอบสนาม (Netting)'],
    ...
    },
    {
      ...
      color: 'bg-orange-500',
      details: {
        equipment: ['แป้นบาสเกตบอลแบบยึดผนังอาคาร (Wall-mounted) แบบพับเก็บได้', 'ห่วงบาสเกตบอลชนิดรองรับการดังก์พร้อมตาข่ายไนลอน'],
